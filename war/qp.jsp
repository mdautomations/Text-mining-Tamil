...
<head>
    ...
    <title>Tamil to English Translation</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index1.jsp">Transalate Easy !</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li id="queryprocess" class="active">
                        <a id="qpclick" onclick="qpprocess();" style="cursor: pointer;"><i class="fa fa-fw fa-desktop"></i> Query Processing</a>
                    </li>
                    <li id="morph" >
                        <a id="morclick" onclick="morphoprocess();" style="cursor: pointer;" ><i class="fa fa-fw fa-desktop"></i> Morphological analysis for English</a>
                    </li>
                    <li id="woa">
                        <a id="woaclick" onclick="woaprocess();" style="cursor: pointer;"><i class="fa fa-fw fa-desktop"></i> Word Order Analysis</a>
                    </li>
                    <li id="errorcor" >
                        <a id="errorclick" onclick="errorprocess();" style="cursor: pointer;"><i class="fa fa-fw fa-desktop"></i> Error Correction</a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Language <small>Translation</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Tamil to English
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <form role="form">
							...
							<button type="button" id="brows" class="btn btn-default">Browse</button>
                             <button type="button" id="processnow" onclick="processnowmethod()" class="btn btn-default">Process</button>
<!--                               <button type="button"  onclick="doQP()" class="btn btn-default">Do Query Processing</button> -->
