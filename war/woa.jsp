        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="qp.jsp"><i class="fa fa-fw fa-desktop"></i> Query Processing</a>
                    </li>
                    <li class="active">
                        <a href="woa.jsp"><i class="fa fa-fw fa-desktop"></i> Word Order Analysis</a>
                    </li>
                    <li >
                        <a href="morph.jsp"><i class="fa fa-fw fa-desktop"></i> Morphological analysis for English</a>
                    </li>
                    <li >
                        <a href="errorcorrention.jsp"><i class="fa fa-fw fa-desktop"></i> Error Correction</a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                           ...
                           <button type="button" id="processnow" class="btn btn-default">Process</button>
